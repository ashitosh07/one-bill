...
import { ToolbarQuickpanelMainToggleComponent } from './toolbar-quickpanel-main-toggle/toolbar-quickpanel-main-toggle.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ToolbarQuickpanelMainToggleComponent
  ],
