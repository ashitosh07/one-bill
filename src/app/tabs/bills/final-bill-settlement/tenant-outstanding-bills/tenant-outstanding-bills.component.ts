...
export class TenantOutstandingBillsComponent implements OnInit {
  ...
  createGridColumns(): any {
    this.columns = [
      ...
      { name: this.amountColumnName, property: 'billAmountLocal', visible: true, isModelProperty: true },
      { name: this.paidColumnName, property: 'paidLocal', visible: true, isModelProperty: true },
      { name: this.toPayColumnName, property: 'toPayLocal', visible: true, isModelProperty: true }] as ListColumn[];
  }
